...
The current GitHub Release, [0.1.2](https://github.com/wandcs/mosh-client-rs/releases/tag/v0.1.2),
...
profile. See the [0.1.2 release review](docs/releases/0.1.2.md) for verification
