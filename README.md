...
The current GitHub Release, [0.1.3](https://github.com/wandcs/mosh-client-rs/releases/tag/v0.1.3),
...
profile. See the [0.1.3 release review](docs/releases/0.1.3.md) for verification
...
```toml
[dependencies]
mosh-client = { git = "https://github.com/wandcs/mosh-client-rs", tag = "v0.1.3", version = "=0.1.3" }
```
